    ...
    <div class='contenedor_formulario' id='contenedor-formulario'>
        ...
        <form class='formulario_datos' id='formulario-datos'>
            <div class='seccion_input'>
                ...
                <input class='input_numero' id='input-numero' name='<?php echo $_POST['numero']?>' value='<?php echo $_POST['numero']?>' placeholder='Ej. 084-2022' maxlength='8'>
            </div>

            <div class='input_izquierda'>
                <label for='input_tipo'>TIPO</label>
                <select id='select-tipo'>
                    <option disabled>Seleccione el tipo de resolución</option>
                    <option <?php echo $_POST['tipo'] == 'Designación de asesor' ? "selected" : "" ?>>Designación de asesor</option>
                    <option <?php echo $_POST['tipo'] == 'Designación de jurado' ? "selected" : "" ?>>Designación de jurado</option>
                    <option <?php echo $_POST['tipo'] == 'Aprobación de proyecto' ? "selected" : "" ?>>Aprobación de proyecto</option>
                    <option <?php echo $_POST['tipo'] == 'Aprobación de acta de sustentación' ? "selected" : "" ?>>Aprobación de acta de sustentación</option>
                </select>
            </div>
            ...
            <div class='seccion-formulario-archivo'>
                ...
                <div class="contenedor-carga">
                    <span class="mensaje-archivo-existente">*Ya se tiene un archivo cargado, si desea puede reemplazarlo haciendo click en la parte superior</span>
                </div>
            </div>
    ...
    <script>
        ...
        botonGuardar.addEventListener("click", (e)=>{
            ...
            if(validarCamposFormulario()){
                validarExistenciaResolucion(numeroResolucion.name, numeroResolucion.value);
            }
        })
        ...
        function validarCamposFormulario(){
            ...
            }else if(inputArchivo.files.length<1 && cambios == true){
        ...
        function validarExistenciaResolucion(numeroResolucion, numeroResolucionNuevo){
            const ajax = new XMLHttpRequest();

            ajax.open('POST', '../controladores/administrador/resoluciones_controlador.php', true);
            ajax.setRequestHeader("content-type","application/x-www-form-urlencoded");
            ajax.send("validar_existencia_resolucion_editando=true&numero=" + numeroResolucion + "&numero_nuevo=" + numeroResolucionNuevo);
                ...
                if(this.readyState == 4 && this.status == 200){
                    ...
                    if(this.responseText){
                        ...
                        if(cambios == true){
                            ...
                            actualizarArchivoResolucion(nombreArchivo);
                        }else{
                            actualizarDatosResolucion();
                        }
                    }
        ...
        function actualizarArchivoResolucion(nombreArchivo){
            if(nombreArchivo.length>80){
                let nombreAcortado=nombreArchivo.split(".");
                nombreArchivo = nombreAcortado[0].substr(0,80) + "... ." + nombreAcortado[1];
            }
            ...
            datos.append('editar_resolucion', 'true');
            datos.append('archivo_modificado', 'true');
            datos.append('numero', numeroResolucion.name);
            datos.append('numero_nuevo', numeroResolucion.value);
        ...
        function actualizarDatosResolucion(){
            const ajax = new XMLHttpRequest();
            ...
            datos.append('editar_resolucion', 'true');
            datos.append('archivo_no_modificado', 'true');
            datos.append('numero', numeroResolucion.name);
            datos.append('numero_nuevo', numeroResolucion.value);
            datos.append('tipo', tipoResolucion.value);
